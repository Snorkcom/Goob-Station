...
ghost-gui-toggle-security-statuses-popup-on = Отображение статусов СБ включено.
ghost-gui-toggle-security-statuses-popup-off = Отображение статусов СБ выключено.
